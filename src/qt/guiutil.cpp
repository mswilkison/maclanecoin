...
{
    if(uri.scheme() != QString("maclanecoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("maclanecoin://"))
    {
        uri.replace(0, 11, "maclanecoin:");
    }
...
{
    return GetAutostartDir() / "maclanecoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("maclanecoin-qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  maclanecoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("maclanecoin-qt"));
